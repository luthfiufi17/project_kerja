...
echo'
<form action="../../process/upload_foto_diri_ktp.php?id='.$Id.'" enctype="multipart/form-data" method="post" autocomplete="off" style="padding:0px;">
    <div align="center" style="padding-bottom:50px;margin:auto;">
	    <div style="background:#fff;padding:25px 20px;margin-bottom:10px;">
            <div id="box_form">
                <h6 style="margin-top:50px;">Upload Foto Anda Dengan Memegang KTP</h6>
    
                <div style="border:dashed 2px #ddd;padding:15px 10px;margin-top:15px;">
                    <h6>Upload foto anda dengan KTP</h6>
