...
echo'
<form action="../../process/upload_cv_mpok.php?id='.$Id.'" enctype="multipart/form-data" method="post" autocomplete="off" style="padding:0px;">
    <div align="center" style="padding-bottom:50px;margin:auto;">
	    <div style="background:#fff;padding:25px 20px;margin-bottom:10px;">
            <div id="box_form">
                <h6 style="margin-top:50px;">Upload CV</h6>
	            ...
	            <a href="../../process/upload_cv_mpok.php?id='.$Id.'" class="abtn_default" type="submit" style="margin-top:10px;">Lewati</a>
